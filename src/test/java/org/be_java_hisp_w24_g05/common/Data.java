...
public class Data {
    ...
    private final List<Post> POSTS = Arrays.asList(
            new Post(1, 1, LocalDate.of(2024, 1, 9), PRODUCTS.get(0),1, 100.0),
            new Post(2, 1, LocalDate.of(2024, 1, 2), PRODUCTS.get(1),2, 200.0),
            new Post(3, 2, LocalDate.of(2023, 12, 26), PRODUCTS.get(2),1, 150.0),
            new Post(4, 2, LocalDate.of(2024, 1, 13), PRODUCTS.get(0),2, 120.0),
            new Post(5, 3, LocalDate.of(2024, 1, 6), PRODUCTS.get(1),1, 180.0),
            new Post(6, 3, LocalDate.of(2023, 12, 29), PRODUCTS.get(2),2, 220.0),
            new Post(7, 4, LocalDate.of(2024, 1, 11), PRODUCTS.get(0),1, 130.0),
            new Post(8, 4, LocalDate.of(2024, 1, 4), PRODUCTS.get(1),2, 250.0)
    );

    private final List<User> FOLLOWED_BY_USER_1 = Arrays.asList(
            new User(2, "User2", new ArrayList<>(), new ArrayList<>(), Arrays.asList(POSTS.get(2))),
