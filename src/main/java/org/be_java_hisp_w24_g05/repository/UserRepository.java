...
public class UserRepository implements IUserRepository{
    ...
    public UserRepository() {
        ...
        Product product = new Product(1, "Laptop", "Electronics", "BrandX", "Silver", "Note1");
        ...
        Post post5 = new Post(5, 3, LocalDate.now().minusDays(10), product2, 1, 180.0);
        Post post6 = new Post(6, 3, LocalDate.now().minusDays(18), product3, 2, 220.0);
        Post post7 = new Post(7, 4, LocalDate.now().minusDays(5), product1, 1, 130.0);
        Post post8 = new Post(8, 4, LocalDate.now().minusDays(12), product2, 2, 250.0);
